      ...
      <AppBar position="static" color='secondary'>
        <Toolbar sx={{position: 'relative'}}>
          ...
          <Typography
            ...
            noWrap
            component="div"
            sx={{ display: { xs: 'block', sm: 'block'},userSelect:'none', marginRight: {md:"10px"}, cursor: 'pointer',fontFamily: 'Josefin Sans', width: {xs: '100%',sm:'fit-content'}, boxSizing: {xs: 'border-box'}, padding: {xs: '5px'}, textAlign: 'center' }}
          >
            BOOK-STORE
          </Typography>
          <Typography
